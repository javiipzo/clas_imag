...
observaciones_testt = pnd.read_csv('datas/zalando/fashion-mnist_test.csv')
class neurona_capa_conv:
    def __init__(self,data_train,data_test):
        self.observaciones_entrenamiento=data_train
        self.observaciones_test=data_test
        #Solo se guardan las características "píxeles"
    def preparar_datos(self,data_train,data_test):
        ...
        plt.legend(['Aprendizaje', 'Test'], loc='upper left')
        plt.show()
        return evaluacion[0],evaluacion[1]
